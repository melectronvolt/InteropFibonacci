...
clr.AddReference(os.path.join(current_directory, 'SOFibonacci.dll'))
from SOFibonacci import MyFiboLinuxClass
...
def execute_dotnet():
    ...
    fibonacciResult = MyFiboLinuxClass.fibonacci_interop_cs(parameters.fiboStart, parameters.fiboMaxTerms,
...
def main_cython_full():
    ...
    fibonacci_interop_cython_full(parameters.fiboStart, parameters.fiboMaxTerms, parameters.fiboMaxValue,
                                  parameters.fiboMaxFactor, parameters.fiboNbrOfLoops, parameters.numberRun)
