...
(function (fbReturn) {
    ...
    fbReturn[fbReturn["TMT"] = 1] = "TMT";
    fbReturn[fbReturn["TB"] = 2] = "TB";
    fbReturn[fbReturn["PRM_ERR"] = 3] = "PRM_ERR";
})(fbReturn || (fbReturn = {}));
/**
 ...
 */
function fibonacci_interop(fbStart, maxTerms = 74, maxFibo, maxFactor, nbrOfLoops) {
    let arTerms = [];
    let arPrimes = [];
    let arError = [];
